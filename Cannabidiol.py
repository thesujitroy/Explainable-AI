...
x = position1[position1['testable']== 'Cannabidiol']
pos1[['instruction_fnumber', 'value']] = x[['instruction_fnumber', 'value']]
# = position1[position1['testable']== 'Cannabidiol'].value

y = position2[position2['testable']== 'Cannabidiol']
pos2[['instruction_fnumber', 'value1']] = y[['instruction_fnumber', 'value']]

z = position3[position3['testable']== 'Cannabidiol']
pos3[['instruction_fnumber', 'value2']] = z[['instruction_fnumber', 'value']]

a = position4[position4['testable']== 'Cannabidiol']
pos4[['instruction_fnumber', 'value3']] = a[['instruction_fnumber', 'value']]

b = position5[position5['testable']== 'Cannabidiol']
pos5[['instruction_fnumber', 'value4']] = b[['instruction_fnumber', 'value']]

c = position6[position6['testable']== 'Cannabidiol']
...
merged = merged.drop_duplicates()
merged.to_csv('merged_Cannabidiol.csv',index=False)
